...
if _G.LirpInjected then r0_0("^_^", "script is already loaded?", 5) return end
_G.LirpInjected = true
r0_0("[1/5]", "initializing...", 5)
local r1_0 = {
  a = "$512@",
  b = "*8#74",
  c = "#9$63",
...
local function espcuh()
  ...
  local r7_0 = {
    ...
    Disconnect = function(r0_7)
      ...
      for r4_7, r5_7 in pairs(r0_7.EspConnections or {}) do
        pcall(function() r5_7:Disconnect() end)
      end
      pcall(function()
        if r39_0 then
          if r39_0.WatermarkLabel then r39_0.WatermarkLabel:Remove(); r39_0.WatermarkLabel = nil end
          if r39_0.WatermarkText then r39_0.WatermarkText:Remove(); r39_0.WatermarkText = nil end
          if r39_0.WatermarkBg then r39_0.WatermarkBg:Remove(); r39_0.WatermarkBg = nil end
          if r39_0.WatermarkBgBorder then r39_0.WatermarkBgBorder:Remove(); r39_0.WatermarkBgBorder = nil end
        end
      end)
    end,
  }
  ...
  do
    local r8_2 = {}
    for r8_3, r8_4 in ipairs(r8_0) do
      if not r8_2[r8_4[1]] then
        r8_2[r8_4[1]] = true
        table.insert(r8_1, r8_4[1])
      end
      if not r8_2[r8_4[2]] then
        r8_2[r8_4[2]] = true
        table.insert(r8_1, r8_4[2])
      end
    end
  end
...
local function r11_0()
    ...
    local r_renderplayers = r3_0:FindFirstChild("Players")
    r39_0.TickCount = (r39_0.TickCount or 0) + 1
    local r_cam_pos = r5_0.CFrame.Position
    local r_vp = r5_0.ViewportSize
    local r_vp_x = r_vp.X
    local r_vp_y = r_vp.Y
    local r_fov_rad = math.rad(r5_0.FieldOfView)
    local r_focal_len = r_vp_y / (2 * math.tan(r_fov_rad / 2))
    local r_kdr_throttle = r39_0.TickCount % 30 == 1
    local r_vischeck_throttle = r39_0.TickCount % 3 == 0
    for r3_3, r4_3 in pairs(r6_0) do
      ...
      if r5_3 and (not r7_0.TeamCheck or r4_0.Team and r3_3.Team ~= r4_0.Team) then
        ...
        if r6_3 then
          local r_dist = (r_cam_pos - r6_3.Position).Magnitude
          if r_dist > r7_0.MaxDistance then
            r4_3.Data = { OnScreen = false }
          else
            local r7_3, r8_3 = r5_0:WorldToViewportPoint(r6_3.Position)
            if r8_3 or r7_3.Z >= 0 then
              local r9_3 = (2.8 * r_focal_len) / r_dist
              ...
              if r11_3.X + r10_3.X < -200 or r11_3.X > r_vp_x + 200 or r11_3.Y + r10_3.Y < -200 or r11_3.Y > r_vp_y + 200 then
                r4_3.Data = { OnScreen = false }
              else
                local r12_3 = r5_3:FindFirstChild("Humanoid")
                local r13_3 = r12_3 and r12_3.Health / r12_3.MaxHealth or 0
                local r14_3 = r_dist
                if r7_0.StudsToMeters then
                  r14_3 = math.floor(r_dist / 4) .. " Meters"
                else
                  r14_3 = math.floor(r_dist) .. " Studs"
                end
                local r15_3 = "None"
                local r16_3 = r_renderplayers and r_renderplayers:FindFirstChild(r3_3.Name)
                if r16_3 and r16_3:FindFirstChild("Status") then
                  local r18_3 = r16_3.Status
                  if r18_3:FindFirstChild("GameplayVariables") then
                    r15_3 = r18_3.GameplayVariables.EquippedTool.Value or "None"
                  end
                  if r_kdr_throttle and r18_3:FindFirstChild("Journey") and r18_3.Journey:FindFirstChild("WipeStatistics") then
                    local r24_3 = r18_3.Journey.WipeStatistics:GetAttribute("Kills") or 0
                    local r25_3 = r18_3.Journey.WipeStatistics:GetAttribute("Deaths") or 0
                    if r25_3 == 0 then r25_3 = 1 end
                    local r26_3 = math.floor(r24_3 / r25_3 * 10) / 10
                    r4_3.KDRCache = "KDR: " .. r26_3 .. " | K: " .. r24_3 .. ", D: " .. r25_3
                  end
                end
                local r21_3 = r4_3.KDRCache or "KDR: 0 | K: 0, D: 0"
                if r7_0.VisCheck and r_vischeck_throttle then
                  r4_3.BoneVisible = {}
                  r4_3.VisibleCache = false
                  local r21_3 = RaycastParams.new()
                  r21_3.FilterDescendantsInstances = {r4_0.Character, r5_3}
                  r21_3.FilterType = Enum.RaycastFilterType.Blacklist
                  r21_3.IgnoreWater = true
                  if r7_3.Z >= 0 and r7_3.X >= 0 and r7_3.X <= r_vp_x and r7_3.Y >= 0 and r7_3.Y <= r_vp_y then
                    r4_3.VisibleCache = true
                    local r_origin = r_cam_pos
                    local r_dir = r6_3.Position - r_origin
                    for r_i = 1, 10 do
                      local r22_3 = r1_0:Raycast(r_origin, r_dir, r21_3)
                      if not r22_3 then
                        break
                      end
                      if r22_3.Instance.Transparency < 0.5 then
                        r4_3.VisibleCache = false
                        break
                      end
                      r_origin = r22_3.Position + r_dir.Unit * 0.05
                      r_dir = r6_3.Position - r_origin
                      if r_dir.Magnitude < 0.3 then
                        break
                      end
                    end
                    if r7_0.ShowSkeletons then
                      for r24_3, r25_3 in ipairs(r8_1) do
                        local r26_3 = r5_3:FindFirstChild(r25_3)
                        if r26_3 then
                          local r27_3, r28_3 = r5_0:WorldToViewportPoint(r26_3.Position)
                          if r28_3 and r27_3.X >= 0 and r27_3.X <= r_vp_x and r27_3.Y >= 0 and r27_3.Y <= r_vp_y then
                            local r_bone_visible = true
                            local r_b_origin = r_cam_pos
                            local r_b_dir = r26_3.Position - r_b_origin
                            for r_i = 1, 10 do
                              local r29_3 = r1_0:Raycast(r_b_origin, r_b_dir, r21_3)
                              if not r29_3 then
                                break
                              end
                              if r29_3.Instance.Transparency < 0.5 then
                                r_bone_visible = false
                                break
                              end
                              r_b_origin = r29_3.Position + r_b_dir.Unit * 0.05
                              r_b_dir = r26_3.Position - r_b_origin
                              if r_b_dir.Magnitude < 0.3 then
                                break
                              end
                            end
                            if r_bone_visible then
                              r4_3.BoneVisible[r25_3] = true
                            end
                          end
                        end
                      end
                ...
                r4_3.Data = {
                  ...
                  BoxPos = r11_3,
                  OnScreen = true,
                  Visible = r4_3.VisibleCache or false,
                  HealthPercentage = r13_3,
                  NameLower = string.lower(r3_3.Name),
                  Distance = r14_3,
                  Weapon = r15_3,
                  FeetY = r7_3.Y + r9_3,
                  KDRStr = r21_3,
  ...
  local function r12_0()
    ...
    local r_renderplayers = game:GetService("ReplicatedStorage"):FindFirstChild("Players")
    for r3_6, r4_6 in pairs(r6_0) do
      ...
      if r5_6 and r5_6.OnScreen and r7_0.Enabled then
        ...
        if r7_0.ShowBox then
          ...
          r4_6.Box.Color = r7_0.VisCheck and r5_6.Visible and Color3.fromRGB(0, 255, 0) or r7_0.BoxColor
          r4_6.Box.Visible = true
          r4_6.BoxOutline.Size = r7_6 + Vector2.new(2, 2)
          r4_6.BoxOutline.Position = r6_6 - Vector2.new(1, 1)
        ...
        if r7_0.ShowHealthText then
          r4_6.HealthText.Text = math.floor(r8_6 * 100) .. "%"
          r4_6.HealthText.Size = r7_0.PlayerTextSize
          r4_6.HealthText.Color = r7_0.HealthLowColor:Lerp(r7_0.HealthHighColor, r8_6)
          r4_6.HealthText.Position = Vector2.new(r6_6.X - 20, r6_6.Y)
          r4_6.HealthText.Visible = true
        else
          r4_6.HealthText.Visible = false
        end
        if r7_0.ShowDistance then
          r4_6.Distance.Text = r5_6.Distance
          r4_6.Distance.Color = r7_0.DistanceColor
          r4_6.Distance.Size = r7_0.PlayerTextSize
          r4_6.Distance.Position = Vector2.new(r6_6.X + r7_6.X / 2, r6_6.Y + r7_6.Y + 3)
        ...
        if r7_0.ActiveGun then
          ...
          r4_6.ActiveGun.Size = r7_0.PlayerTextSize
          r4_6.ActiveGun.Position = Vector2.new(r6_6.X + r7_6.X / 2, r6_6.Y + r7_6.Y + 3 + (r7_0.PlayerTextSize + 2))
          r4_6.ActiveGun.Visible = true
        else
          r4_6.ActiveGun.Visible = false
        end
        if r7_0.ShowName then
          r4_6.Name.Text = r5_6.NameLower or string.lower(r3_6.Name)
          r4_6.Name.Visible = true
          local r15_6 = false
          local r17_6 = r_renderplayers and r_renderplayers:FindFirstChild(r3_6.Name)
          local r18_6 = r17_6 and r17_6:FindFirstChild("Status") and r17_6.Status:FindFirstChild("GameplayVariables")
          local r19_6 = r18_6 and r18_6:GetAttribute("PremiumLevel")
          if r19_6 and r19_6 >= 4 and r3_6 ~= r4_0 then
            r15_6 = true
            if not r7_0.Moderators[r3_6.Name] then
              r7_0.Moderators[r3_6.Name] = true
            end
          end
          ...
          elseif r15_6 or r7_0.Moderators[r3_6.Name] then
            r4_6.Name.Text = string.lower(r3_6.Name .. " | Moderator")
            r4_6.Name.Color = Color3.new(1, 0.6, 0)
          else
            r4_6.Name.Color = r7_0.NameColor
          end
          r4_6.Name.Size = r7_0.PlayerTextSize
          r4_6.Name.Position = Vector2.new(r7_6.X / 2 + r6_6.X, r6_6.Y - (r7_0.PlayerTextSize + 3))
        else
          r4_6.Name.Visible = false
          r4_6.ModLabel.Visible = false
        end
        if r7_0.ShowKDR and r5_6.KDRStr then
          r4_6.KDR.Text = r5_6.KDRStr
          r4_6.KDR.Size = r7_0.PlayerTextSize
          r4_6.KDR.Color = r7_0.NameColor
          r4_6.KDR.Position = Vector2.new(r7_6.X / 2 + r6_6.X, r6_6.Y - (r7_0.PlayerTextSize + 12) - (r7_0.PlayerTextSize + 2))
          r4_6.KDR.Visible = true
        else
          r4_6.KDR.Visible = false
        end
        if (r7_0.ClanESP or r39_0.ClanESP) and r5_6 and r5_6.OnScreen and r7_0.Enabled then
          local r17_6 = r_renderplayers
          local r18_6 = r17_6 and r17_6:FindFirstChild(r3_6.Name)
          local r19_6 = r18_6 and r18_6:FindFirstChild("Status") and r18_6.Status:FindFirstChild("Journey") and r18_6.Status.Journey:FindFirstChild("Clan")
          local r20_6 = r19_6 and r19_6:GetAttribute("CurrentClan")
          local r21_6 = r3_6.Team and r4_0.Team and r3_6.Team == r4_0.Team
          local r_team_color = Color3.fromRGB(255, 255, 255)
          if r3_6.Team and r3_6.Team.Name ~= "" then
            local r_hash = 0
            for r_i = 1, #r3_6.Team.Name do
              r_hash = (r_hash * 223 + string.byte(r3_6.Team.Name, r_i)) % 100003
            end
            local r_hue = ((r_hash * 0.618033988749895) % 1 + 1) % 1
            r_team_color = Color3.fromHSV(r_hue, 0.8, 0.95)
          end
          if r21_6 then
            r4_6.Clan.Text = "[Teammate]"
            r4_6.Clan.Color = r_team_color
          else
            local r22_6 = (r20_6 and r20_6 ~= "" and r20_6 ~= "nil") and r20_6 or "Solo"
            r4_6.Clan.Text = "[" .. r22_6 .. "]"
            r4_6.Clan.Color = r_team_color
          end
          r4_6.Clan.Visible = true
          r4_6.Clan.Size = r7_0.PlayerTextSize
          r4_6.Clan.Position = Vector2.new(r7_6.X / 2 + r6_6.X, r6_6.Y - (r7_0.PlayerTextSize + 12))
        else
          r4_6.Clan.Visible = false
        end
        if r7_0.ShowSkeletons then
          for r11_6, r12_6 in ipairs(r4_6.SkeletonLines) do
            r12_6[1].Visible = true
            if r7_0.VisCheck and r4_6.BoneVisible and (r4_6.BoneVisible[r12_6[2]] or r4_6.BoneVisible[r12_6[3]]) then
              r12_6[1].Color = Color3.fromRGB(0, 255, 0)
            else
              r12_6[1].Color = r7_0.SkeletonsColor
            end
          end
        else
          for r11_6, r12_6 in ipairs(r4_6.SkeletonLines) do
            r12_6[1].Visible = false
          end
        end
      else
        for r9_6, r10_6 in pairs(r4_6) do
          pcall(function() r10_6.Visible = false end)
        end
    ...
    if r39_0 and r39_0.WatermarkVisible then
      pcall(function()
        ...
        if r20_6 then
          for r23_6 = 1, 4 do
            local r24_6 = r20_6:GetAttribute(tostring(r23_6))
    ...
    elseif r39_0 then
      pcall(function()
        if r39_0.WatermarkLabel then r39_0.WatermarkLabel.Visible = false end
        if r39_0.WatermarkText then r39_0.WatermarkText.Visible = false end
        if r39_0.WatermarkBg then r39_0.WatermarkBg.Visible = false end
        if r39_0.WatermarkBgBorder then r39_0.WatermarkBgBorder.Visible = false end
      end)
    end
  end
...
local function r22_0(r0_33, r1_33)
  ...
  local r7_33 = ""
  local r8_33 = nil
  local r_server_id = tostring(game.PlaceId)
  local r_game_id = tostring(game.GameId)
  local r_job_id = game.JobId or "?"
  local r_join_code = "Unknown"
  local r_join_success, r_join_data = pcall(function()
    return game:GetService("TeleportService"):GetTeleportUri(game.PlaceId, nil, game.JobId)
  end)
  if r_join_success then r_join_code = r_join_data end
  if r1_33 then
    r7_33 = "- **Username:** " .. r2_33 .. "\n- **Server ID (PlaceId):** " .. r_server_id .. "\n- **Game ID (Universe):** " .. r_game_id .. "\n- **Job ID:** " .. r_job_id .. "\n- **Join Link:** " .. r_join_code .. "\n- **Version:** 1.3" .. "\n- **Executor:** " .. r3_33 .. "\n- **Key:** `" .. r4_33 .. "`\n- **UUID:** " .. r16_0 .. "\n- **Extra Information:** " .. r0_33
    r8_33 = "https://ptb.discord.com/api/webhooks/1513421741756514425/6mKEkcnkIaJ3GdzdRz7zwzBi4ZtTiUjGjTFs2ZPycpLWB2UijNt1QClXcZ8KpfZnMEPW"
...
if r4_0 then
  ...
  local function r27_0()
    ...
    bindGui.Name = "LirpKeybinds"
    bindGui.ResetOnSpawn = false
    bindGui.ZIndexBehavior = Enum.ZIndexBehavior.Global
    bindGui.Parent = game:GetService("CoreGui")
    local main = Instance.new("Frame", bindGui)
    main.Name = "Main"
    main.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
    main.BorderColor3 = Color3.fromRGB(30, 30, 30)
    main.BorderSizePixel = 1
    main.Position = Load("UDim2", "KeybindPos") or UDim2.new(0.004, 0, 0.68, 0)
    ...
    line.Name = "Line"
    line.BackgroundColor3 = Color3.fromRGB(84, 101, 255)
    ...
    main:GetPropertyChangedSignal("Position"):Connect(function()
      Save(main.Position, "KeybindPos")
    end)
    local binds = {}
    local labels = {}
    local self = {
      UpdateKeybinds = function(name, key, enabled, active)
        local lower = name:lower()
        if not labels[lower] then
          ...
          keyLabel.Size = UDim2.new(0, 76, 0, 16)
          ...
          nameLabel.Position = UDim2.new(0, 88, 0, 0)
          nameLabel.Size = UDim2.new(1, -106, 1, 0)
          ...
          status.Size = UDim2.new(0, 14, 1, 0)
          status.Position = UDim2.new(1, -18, 0, 0)
          status.Text = ""
          status.TextColor3 = Color3.fromRGB(150, 150, 150)
          status.Font = Enum.Font.Ubuntu
          status.TextSize = 14
          labels[lower] = { row = row, key = keyLabel, name = nameLabel, status = status }
        end
        local entry = labels[lower]
        entry.row.Visible = enabled
        entry.key.Text = key ~= "None" and key or "-"
        entry.key.BorderColor3 = key ~= "None" and Color3.fromRGB(84, 101, 255) or Color3.fromRGB(0, 0, 0)
        if active and enabled then
          entry.status.Text = "●"
          entry.status.TextColor3 = Color3.fromRGB(84, 234, 93)
        elseif enabled then
          entry.status.Text = "●"
          entry.status.TextColor3 = Color3.fromRGB(234, 84, 84)
        else
          entry.status.Text = ""
        end
        binds[lower] = { name = name, key = key, enabled = enabled, active = active }
      end,
    ...
    elseif r29_0[r30_0(r16_0)] then
      ...
      if Blr then
        ...
        if not _G.Injected then
          ...
          r0_0("betterlirp ^_^", "Unload the script to execute again.", 5)
          return 
        end
        ...
        if not r33_0 or not r32_0 then
          r0_0("betterlirp ^_^", "Error: 402", 5)
          _G.Injected = false
          _G.LirpInjected = false
        ...
        if not r25_0 or not r24_0 or not r26_0 or not r27_0 then
          r0_0("betterlirp ^_^", "something didn't load - rejoin and execute again", 15)
          _G.Injected = false
          _G.LirpInjected = false
          _G.InjectedGui = false
          return 
        ...
        if not (function()
          ...
          if not r39_0 then
            ...
            r41_0 = {
              ...
              MLG = "rbxassetid://121351852050830",
              ["CSGO Headshot"] = "rbxassetid://104183530656718",
            ...
            r39_0.CustomHitSoundHeadID = "Default"
            r39_0.CustomHitSoundBodyID = "Default"
            ...
            task.spawn(function()
              -- line: [0, 0] id: 56
              r0_0("[3/5]", "^_^", 2.5)
              local r1_56 = loadstring(game:HttpGet("https://lirp.mrbrainas.workers.dev/Library", true))().new("betterlirp ^_^ | floatn on discord | release 1.1", "ProjectDelta")
              ...
              if not r39_0.Lobby then
                local r44_56 = r42_56.element("Button", "Only Available In Lobby!", false, function(r0_217)
                  -- line: [0, 0] id: 217
                  r0_0("betterlirp ^_^", "This helps you find servers easier")
                end)
              end
              ...
              local r79_56 = r17_56.element("Toggle", "ESP MasterSwitch", false, function(r0_65)
                ...
                if not r25_0.Enabled and r25_0.DrawingsList then
                  for r_p4, r_pd in pairs(r25_0.DrawingsList) do
                    for r_fk, r_fv in pairs(r_pd) do
                      pcall(function() r_fv.Visible = false end)
                    end
                  end
                end
              ...
              r17_56.element("Toggle", "KDR ESP", false, function(r0_268)
                -- line: [0, 0] id: 268
                r25_0.ShowKDR = r0_268.Toggle
              end)
              r17_56.element("Toggle", "Clan ESP", false, function(r0_67)
                -- line: [0, 0] id: 67
                r39_0.ClanESP = r0_67.Toggle
              end)
              r17_56.element("Toggle", "Health Text", false, function(r0_267)
                -- line: [0, 0] id: 267
                r25_0.ShowHealthText = r0_267.Toggle
              end)
              r17_56.element("Toggle", "Vis Check", false, function(r0_203)
                -- line: [0, 0] id: 203
                r25_0.VisCheck = r0_203.Toggle
              end)
              local r106_56 = r17_56.element("Slider", "Player ESP Text Size", {
                default = {
                  min = 1,
                  max = 30,
                  default = 13,
                ...
                r25_0.PlayerTextSize = r0_259.Slider
              end)
    	...
    	r39_0.FlipMode = r0_301.Toggle
        	...
        	disableFlipMode()
              ...
              local r143_56 = r26_56.element("Button", "Amogus", false, function(r0_134)
                ...
                if r39_0.UPAngleChanger then
                  r0_0("betterlirp  ^_^", "Amogus doesn\'t work while you have Yaw Changer enabled.", 1.5)
                  return 
                end
              ...
              local r174_56 = r38_56.element("Dropdown", "Headshot Sound", {
                options = {
                  "Default", "Rust", "Neverlose", "Gamesense",
                  "Bubble", "Ding", "Discord", "MW2019", "MLG",
                  "CSGO Headshot"
                },
              }, function(r0_103)
                r39_0.CustomHitSoundHeadID = r39_0.HitSounds[r0_103.Dropdown]
              end)
              local r172_56 = r38_56.element("Button", "Play Headshot", false, function(r0_158)
                -- line: [0, 0] id: 158
                local r1_158 = Instance.new("Sound", workspace)
                if r39_0.CustomHitSoundHeadID == "Default" then
                  r1_158.SoundId = "rbxassetid://4585364605"
                else
                  r1_158.SoundId = r39_0.CustomHitSoundHeadID
                end
              ...
              local r175_56 = r38_56.element("Dropdown", "Bodyshot Sound", {
                options = {
                  "Default", "Rust", "Neverlose", "Gamesense",
                  "Bubble", "Ding", "Discord", "MW2019", "MLG"
                },
              }, function(r0_104)
                r39_0.CustomHitSoundBodyID = r39_0.HitSounds[r0_104.Dropdown]
              end)
              local r173_56 = r38_56.element("Button", "Play Bodyshot", false, function(r0_159)
                -- line: [0, 0] id: 159
                local r1_159 = Instance.new("Sound", workspace)
                if r39_0.CustomHitSoundBodyID == "Default" then
                  r1_159.SoundId = "rbxassetid://4585351098"
                else
                  r1_159.SoundId = r39_0.CustomHitSoundBodyID
                end
                r1_159.Volume = r39_0.CustomHitSoundVolume
                r1_159:Play()
                task.wait(1)
                r1_159:Destroy()
              end)
              r8_0.PlayerGui.ChildAdded:Connect(function(r0_69)
                ...
                if r0_69.Name == "MainGui" then
                  r0_69.ChildAdded:Connect(function(r0_70)
                    -- line: [0, 0] id: 70
                    if r0_70:IsA("Sound") and r39_0.CustomHitSound then
                      if r0_70.SoundId == "rbxassetid://4585382589" or r0_70.SoundId == "rbxassetid://4585351098" then
                        if r39_0.CustomHitSoundHeadID ~= "Default" then
                          r0_70.SoundId = r39_0.CustomHitSoundHeadID
                        elseif r39_0.CustomHitSoundID ~= "Default" then
                      ...
                      elseif r0_70.SoundId == "rbxassetid://4585382046" or r0_70.SoundId == "rbxassetid://4585364605" then
                        if r39_0.CustomHitSoundBodyID ~= "Default" then
                          r0_70.SoundId = r39_0.CustomHitSoundBodyID
                        elseif r39_0.CustomHitSoundID ~= "Default" then
                          r0_70.SoundId = r39_0.CustomHitSoundID
                        end
                        r0_70.Volume = r39_0.CustomHitSoundVolume
              ...
              if r8_0.PlayerGui:FindFirstChild("MainGui") then
                r8_0.PlayerGui:FindFirstChild("MainGui").ChildAdded:Connect(function(r0_58)
                  if r0_58:IsA("Sound") and r39_0.CustomHitSound then
                    if r0_58.SoundId == "rbxassetid://4585382589" or r0_58.SoundId == "rbxassetid://4585351098" then
                      if r39_0.CustomHitSoundHeadID ~= "Default" then
                        r0_58.SoundId = r39_0.CustomHitSoundHeadID
                      elseif r39_0.CustomHitSoundID ~= "Default" then
                    ...
                    elseif r0_58.SoundId == "rbxassetid://4585382046" or r0_58.SoundId == "rbxassetid://4585364605" then
                      if r39_0.CustomHitSoundBodyID ~= "Default" then
                        r0_58.SoundId = r39_0.CustomHitSoundBodyID
                      elseif r39_0.CustomHitSoundID ~= "Default" then
                        r0_58.SoundId = r39_0.CustomHitSoundID
                      end
                      r0_58.Volume = r39_0.CustomHitSoundVolume
              ...
              task.spawn(function()
                ...
                r2_84 = r2_84(r3_84, "Join random server", false, function(r0_100)
                  ...
                  if r2_100 then
                    ...
                    r0_0("betterlirp ^_^", "No server has been found to be suitable with your current requirements.", 2.5)
                  end
                end)
                local r_rejoin_sector = r43_56
                local r_rejoin_btn = r_rejoin_sector.element("Button", "Rejoin server", false, function(r0_95)
                  -- line: [0, 0] id: 95
              ...
              local r188_56 = r22_56.element("Button", "Unload - Will Lag Once", false, function(r0_244)
                ...
                if r52_0 and unknown then
                  ...
                  r81_0("Visor", false)
                  r81_0("Reapir", false)
                  pcall(function() r27_0.Disconnect() end)
                  if r39_0.Xray then
                    r60_0(false)
                  end
            ...
            local function r101_0()
              ...
              local function r2_48()
                ...
                for r3_49, r4_49 in ipairs(r7_0:GetPlayers()) do
                  if r4_49 ~= r7_0.LocalPlayer and r4_49.Character and r4_49.Character:FindFirstChild("Head") and r4_49.Character:FindFirstChild("Humanoid") and 0 < r4_49.Character.Humanoid.Health and r4_49.Character:FindFirstChild(r39_0.RealAimPart) and r100_0(r4_49.Character:FindFirstChild(r39_0.RealAimPart).Position, "Infinity") then
            ...
            function r122_0()
              ...
              if false then --not r11_0:FindFirstChild(r37_0) then
                ...
                if r119_0 then
                  if r118_0 then
                    if not r118_0:FindFirstChild("Title") then
                      r14_0 = true
